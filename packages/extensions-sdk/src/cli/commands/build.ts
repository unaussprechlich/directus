...
import { generateBundleEntrypoints } from '../utils/generate-bundle-entrypoints';
...
async function buildBundleExtension({
	...
	const entrypointApp = generateBundleEntrypoints(entries, APP_OR_HYBRID_EXTENSION_TYPES);
	const entrypointApi = generateBundleEntrypoints(entries, API_OR_HYBRID_EXTENSION_TYPES);
